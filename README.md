...
You may use other JS runtimes. [Here](https://github.com/kclauhk/youtube-downloader/blob/remoteJS/JSRUNTIME.md#javascript-runtime) are some examples.
...
- `$client_data` - client data in an array of key-value pairs which must contain "clientName" and "clientVersion",  
